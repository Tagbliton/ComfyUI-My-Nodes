...
- **v1.1.3**
	...
	_优化节点_ `Flux助手` _API输入机制_

  	`比较分流器` _节点可以输入更多类型进行比较，已测试_ `INT.FLOAT.BOOLEAN.STRING.IMAGE.MASK.AUDIO.LATENT` _等大部分类型_
...
- **v1.1.2**
	...
	_优化_ `Flux助手` _获取文本逻辑_

  	`比较分流器` _和_ `选择输出器` _可以进行空输入_
